    ...
    return (
        <>
            <div className={styles.about}>
                ...
                <p className={styles.subDescription}>The University of Chicago Space Program (also known as SEDS-UChicago) is UChicago’s premier space- and aerospace-focused registered student organization, and the University’s chapter of the national Students for the Exploration and Development of Space (SEDS). Since its inception in 2020, the club has grown significantly in size and scope. In 2022, the club hosted SpaceVision, SEDS-USA’s national conference which was attended by 400+ students and 90 speakers. In 2023, UCSP began research and development of an even more ambitious project – UChicago’s first-ever satellite, the PULSE-A CubeSat. Going into the 2024-25 academic year, UCSP boasts over 75 active members, and will be hosting</p>
